...
parser.add_argument('--END_TEST', type = datetime, default = timezone.localize(datetime(2018, 6, 22)),
                    help='ending date of testing data (default: 2018, 6, 30)')

parser.add_argument('--PHASE_SELECT', type = bool, default = True,
...
parser.add_argument('--MAX_CAPACITY', type=float, default=20, metavar='G',
...
parser.add_argument('--TRAIN_EPISODES', type=int, default=7, metavar='N',
...
#  LSTM Properties
#  
#  Below are all arguments required for defining LSTM modules
#
# ---------------------------------------------------------------------------------
# set parser that defines invariant global variables
parser = argparse.ArgumentParser(description='LSTM Hyperparameters')

parser.add_argument('--windowSize', type = int, default = 100, metavar = 'N',
                    help='control LSTM memory length (training data length) (default: 100)')

parser.add_argument('--numVariables', type = int, default = 3, metavar = 'N',
                    help='control number of features in EV proflie fed into the learning modules (default: 3)')

parser.add_argument('--epochs', type = int, default = 300, metavar = 'N',
                    help='training epochs of LSTM (default: 300)')

parser.add_argument('--nStep', type = int, default=30, metavar = 'N',
                    help='control next n prediction made by LSTM (default: 3)')

parser.add_argument('--isTrain', type = bool, default = False, metavar = 'B',
                    help='decide if we train a LSTM model or load one(default: True)')

# pack up parsers
lstmArgs = parser.parse_args()
...
#  Result Directories
#  
#  Below are all directories that store result of figures and data
#
# ---------------------------------------------------------------------------------
