...
class EVEnv(gym.Env):
  ...
  def reset(self, isTrain):
    ...
    if isTrain:
      ...
      #name = 'C:/Users/zhiling zhou/Desktop/MyGit/Caltech_ACN/py/gym-EV_data/real_train/data10.npy'
      name = 'C:/Users/zhiling zhou/Desktop/MyGit/Caltech_ACN/py/gym-EV_data/real_train/data' + str(day) + '.npy'
    else:
      day = random.randint(0, 21)
      name = 'C:/Users/zhiling zhou/Desktop/MyGit/Caltech_ACN/py/gym-EV_data/real_test/data' + str(day) + '.npy'
    # Load data
    data = np.load(name)
    self.data = data
